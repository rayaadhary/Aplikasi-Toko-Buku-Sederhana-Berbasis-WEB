    ...
    <form action="index.php?p=savebeli" method=post>
        <center>
            <table border=0>
                ...
                echo "<center><img src='./images/$kodebrg.jpg' width=40% height=40%></center>";
                echo "<br>";
                ...
                do
                {
                    ...
                    echo "<tr><td width=150>Kode Barang<td width=100><input name=kodebrg value='$kodebrg' readonly size=10>";
                    echo "<tr><td>Nama Barang<td><input name=namabarang value='$namabarang' readonly size=30>";
                    echo "<tr><td>Harga<td><input name=harga value='$harga' readonly size=10>";
                    echo "<tr><td>Stok<td><input name=stok value='$stok' readonly size=5>";
